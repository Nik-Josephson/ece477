...
% Auto-generated by MATLAB on 2018/02/16 12:25:54
...
output = table;
output.Num = cell2mat(raw(:, 1));
output.FreeMem = cell2mat(raw(:, 2));
output.LAone = cell2mat(raw(:, 3));
output.LAfive = cell2mat(raw(:, 4));
output.LAten = cell2mat(raw(:, 5));
output.Prun = cell2mat(raw(:, 6));
output.Ptotal = cell2mat(raw(:, 7));
